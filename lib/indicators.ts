...
export const INDICATOR_REGISTRY: Record<IndicatorId, IndicatorMetadata> = {
  "ppi": {
    ...
    description:
      "Tracks real productivity performance using RescueTime's Productivity Pulse metric. Values above 100 indicate higher productivity than the January 2025 baseline. The index measures time spent in productive vs distracting activities, with scores ranging from 0 (100% distracting) to 100+ (highly focused work). Based on actual computer usage data, not self-reported estimates.",
    unit: "Index (Jan 2025 = 100)",
    frequency: "monthly",
    category: "Productivity",
    source: "RescueTime Productivity Pulse",
    calculation: "RescueTime Productivity Pulse score, normalized to January 2025 baseline (102.5)",
    color: "#667eea",
